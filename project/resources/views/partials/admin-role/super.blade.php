    ...
    <li>
        ...
        <ul class="collapse list-unstyled
            ...
            <li>
                <a href="{{ route('admin.model.index') }}"><span>{{ __('Model Number') }}</span></a>
            </li>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="vendor" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-vendor-color') }}"><span>{{ __('Colors') }}</span></a>
            </li>
        </ul>
    </li>
    ...
    <li>
        <a href="#vendor1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-verification-check"></i>{{ __('Order Verifications') }}
        </a>
    ...
    <li>
        <a href="{{ route('admin-subscription-index') }}" class=" wave-effect"><i class="fas fa-dollar-sign"></i>{{ __('Plans') }}</a>
    </li>
