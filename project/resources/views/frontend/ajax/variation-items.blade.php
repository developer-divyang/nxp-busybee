            ...
            <div class="sizeBox">
                ...
                <div style="margin-top:10px; display:flex; flex-direction:column; flex:1; width:50%;min-width:45px">
                    ...
                    <div class="counter">
                        ...
                        <input type="text" data-id="{{ $color->id }}" data-color-id="{{ $color->color_name }}" data-size-id="{{ $size_n->size_name }}" class="quantity-input color-quantity" name="quantity[{{$pcolor->color_id}}][{{$size_n->id}}][]" value="{{ $quantity }}" readonly>
