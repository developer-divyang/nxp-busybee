...
class Product extends Model
{
  ...
  protected $fillable = ['user_id','category_id','product_type','affiliate_link','sku', 'fit', 'bill','subcategory_id', 'childcategory_id', 'attributes', 'name', 'photo', 'size','size_qty','size_price', 'color', 'image', 'details','price', 'blank_price', 'weight', 'previous_price','stock','policy','status', 'views','tags','featured','best','top','hot','latest','big','trending','sale','features','colors','product_condition','ship','meta_tag','meta_description','youtube','type','file','license','license_qty','link','platform','region','licence_type','measure','discount_date','is_discount','whole_sell_qty','whole_sell_discount','catalog_id','slug','language_id','flash_count','hot_count','new_count','sale_count','best_seller_count','popular_count','top_rated_count','big_save_count','trending_count','page_count','seller_product_count','wishlist_count','vendor_page_count','min_price','max_price','product_page','post_count','minimum_qty','preordered','language_id','color_all','size_all','stock_check','fit','bill','style','closure','panel','model_number','brand_id','fabric','min_price','max_price','constant'];
    ...
    //get colors from ProductColor table usinh hasmany
    public function getColors()
    {
        return $this->hasMany('App\Models\ProductColor');
    }

    //get color images from ProductColorImage table  color id and product id base
    public function getColorImages()
    {
        return $this->hasMany('App\Models\ProductColorImage');
    }
